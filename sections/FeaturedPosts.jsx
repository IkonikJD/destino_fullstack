...
import { getFeaturedNoticies } from '../services'
...
const FeaturedPosts = () => {
  ...
  const customLeftArrow = <CustomLeftArrow /> // Usamos el componente personalizado para la flecha izquierda
  const customRightArrow = <CustomRightArrow /> // Usamos el componente personalizado para la flecha derecha
